...
describe('extension update checks', () => {
  ...
  it('keeps package, Chrome manifest, update CSP and release URLs aligned', () => {
    ...
    expect(UPDATE_MANIFEST_URL).toContain('/Onenightcarnival/dsh-browser/')
    expect(RELEASES_URL).toBe('https://github.com/Onenightcarnival/dsh-browser/releases')
  })
})
